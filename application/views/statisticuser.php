...
<link rel="stylesheet" href="<?=base_url(); ?>media/css/statisticusers.css" rel="stylesheet" type="text/css"/>
<link rel="stylesheet" href="<?=base_url(); ?>media/css/statisticusers1.css" rel="stylesheet" type="text/css"/>
...
<link href="<?=base_url(); ?>media/css/tab1.css" rel="stylesheet" type="text/css" />
<style>
input{margin:5px;}
</style>
...
<p class="contact_text">Ваша статистика(история)</p>
<div class="container"> 
<section> 
...
<div id="contactconteiner"> 
 ...
 <!— текст поле слайдера —> 
 <h3 class="title_tab"></h3> 

 <section> 


<?php if ($session['prava']=="admin")
					{ ?> 
    <a style="border:1px solid red; padding:5px" href="<?=base_url(); ?>statistic/clearn1/<?=$id; ?>/<?=$itog; ?>">Закончить игру</a>
    <a style="border:1px solid red; padding:5px" href="<?=base_url(); ?>registration/edit/<?=$id; ?>">Редактировать данные</a>
    <form action="<?=base_url(); ?>statistic/userform" method="POST">
    <input name="deposit" type="text"> <input name="submit" type="submit" value="Депозит">
    <input name="vivod" type="text"> <input type="submit" name="submit" value="Вывод">
    <input type="hidden" name="id" value="<?=$id; ?>">
    <input type="hidden" name="itog" value="<?=$itog; ?>">
    </form>
 <?php } 
 else {?>
 <a style="border:1px solid red; padding:5px" href="<?=base_url(); ?>statistic/clearn/<?=$itog; ?>">Закончить игру</a> 
  <?php }?>   

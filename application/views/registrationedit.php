        ...
        <div class="registrationpl-contact">
            <div class="container">
                ...
                <div class="two_third_contact lastcolumn">
                    ...
                    <div id="contact_Form">
                        <form method="post" id="contact_form" enctype="multipart/form-data" action="<?=base_url(); ?>registration/edit/<?=$edit->id; ?>" >
                    ...
                    <path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/>
                                ...
                                echo  '<p class="error25" style="color:#fff;">Пользователь успешно зарегистрирован</p>';}
                                    ...
                                    <input type="text"id="name" name="name" value="<?php echo $edit->name;?>" placeholder="Иванов Иван Иванович"  />
                                </div>
                                <div class="email">
                                    <label for="nick">Логин на PokerStars:</label>
                                    <p> Пожалуйста, введите ваш логин на PokerStars</p>
                                    <input id="nick" name="nick" type="text"  value="<?php echo $edit->nick;?>" placeholder="Ivan2016" required />
                                </div>
                                <div class="email">
                                    <label for="nick">Город:</label>
                                    <p> Пожалуйста, введите ваш город проживания</p>
                                    <input id="nick" name="city" type="text"  value="<?php echo $edit->city;?>" placeholder="Одесса"  />
                                </div>
                                <div class="email">
                                    <label for="email">Почтовый адрес:</label>
                                    <p>Пожалуйста, введите ваш почтовый адрес</p>
                                    <input id="email" name="email" type="text"  value="<?php echo $edit->email;?>" placeholder="ivan2016@mail.ru"  />
                                </div>
                                <div class="email">
                                    <label for="email">Телефон 1:</label>
                                    <p>Пожалуйста, введите ваш телефон</p>
                                    <input id="email" name="phone1" type="text"  value="<?php echo $edit->phone1;?>" placeholder="+3 (093) 780 38 61"  />
                                </div>
                                <div class="email">
                                    <label for="email">Телефон 2:</label>
                                    <p>Пожалуйста, введите ваш телефон</p>
                                    <input id="email" name="phone2" type="text"  value="<?php echo $edit->phone2;?>" placeholder="+3 (063) 550 44 11"  />
                                </div>
                                <div class="email">
                                    ...
                                    {
                                        $c='';
                                        if ($edit->affileyt==$gamer->nick){
                                            $c='selected';
                                        }
                                        echo '<option '.$c.' value="',$gamer->nick,'"><p>',$gamer->nick,'</p></option>';
                                    } ?>
                                ...
                                <div class="email">
                                    ...
                                    <input id="email" name="persent" type="text"  value="<?php $edit->persent;?>" placeholder="15%"  />
                                </div>
                                <div class="email">

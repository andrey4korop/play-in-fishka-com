...
<p class="contact_text">ТАБЛИЦА ИГРОКОВ</p>
<div class="container"> 
<section> 
...
<th class="nosort"><h3>Стол 1</h3></th> 
<th class="nosort"><h3>Стол 2</h3></th> 
...
<td class="nosort"><h3>Номер игры</h3></td> 
<td class="nosort"><h3>Номер игры</h3></td> 
</tr> 
<tr> 
<th class="nosort"><h3>Докупка</h3></th> 
<td class="nosort"><h3>Номер игры</h3></td> 
<td class="nosort"><h3>Номер игры</h3></td> 
</tr> 
<tr> 
...
<tr> 
<th class="nosort"><h3>Плата за время</h3></th> 
<td class="nosort"><h3>Номер игры</h3></td> 
<td class="nosort"><h3>Номер игры</h3></td> 
</tr> 
<tr> 
<th class="nosort"><h3>Рейкбэк</h3></th> 
<td class="nosort"><h3>Номер игры</h3></td> 
<td class="nosort"><h3>Номер игры</h3></td> 
</tr> 
<tr> 
<th class="nosort"><h3>Выход из-за стола</h3></th> 
<td class="nosort"><h3>Номер игры</h3></td> 
<td class="nosort"><h3>Номер игры</h3></td> 
</tr> 
<tr> 
<th class="nosort"><h3>Итог</h3></th> 
<td class="nosort"><h3>Номер игры</h3></td> 
<td class="nosort"><h3>Номер игры</h3></td> 
</tr> 
...
<div id="contactconteiner"> 
 ...
 <table cellpadding="0" cellspacing="0" border="0" id="table" class="tinytable"><!-- таблица, твою мать))-->
                           <?php     foreach ($table as $key => $value) 
                                    {
                                        if ($key==1||$key==2||$key==3||$key==4||$key==10||$key==11||$key==5)
                                        {
                                            echo '<tr>';
                                            foreach ($value as  $td) 
                                            {
                                                echo '<td style="border: 1px solid black; text-align: center;">',$td,'</td>';
                                            }
                                            echo '</tr>';
                                        }
                                    }

...
<title>Добро пожаловать на PLAY IN FISHKA</title>
...
<section id="tournaments">
    <div class="quote-icon"><img src="<?=base_url(); ?>media/images/icon_logo2.png" alt="" />
        </div>
            <div class="parallax">
          ...
          <h2 class="section_title1">Добро пожаловать на<span class="secondtxt2"> PLAY IN</span><span class="secondtxt1"> FISHKA</span></h2>
                                    </article>
                            </section>
        <br/>
		    ...
		    <div class="main-signin__middle">
			    <div class="middle__form">
                    <form action="<?=base_url(); ?>" method="POST">
				            <input type="text" placeholder="Логин" name="nick">
